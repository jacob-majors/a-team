...
export default function LandingPage() {
  return (
    <div className="bg-white">
      ...
      <section className="bg-white px-5 py-14 sm:px-8 sm:py-16 lg:px-16">
        <div className="mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-[1fr_1.4fr] md:gap-16">
          <ScrollReveal direction="left">
            <h2 className="text-4xl font-black leading-[0.95] text-gray-800 sm:text-6xl lg:text-7xl">
              More<br />than a<br />
              <span className="text-brand-600">bike team.</span>
            </h2>
          </ScrollReveal>
          <ScrollReveal direction="right" delay={100}>
            <p className="mb-5 max-w-2xl text-base leading-7 text-gray-600 sm:text-lg">
      ...
      {/* ── NICA + NORCAL ───────────────────────────────────── */}
      <section className="bg-gray-50 px-5 py-14 sm:px-8 sm:py-16 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <ScrollReveal direction="up">
            <h2 className="mb-8 text-3xl font-black text-gray-800 sm:text-4xl">Our League</h2>
          </ScrollReveal>
            ...
            <ScrollReveal direction="left">
              <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-sm h-full flex flex-col">
                <div className="bg-gradient-to-r from-brand-600 to-brand-800 px-6 py-5">
                  ...
                  <p className="text-brand-100/80 text-sm mt-1">National Interscholastic Cycling Association</p>
                </div>
              ...
              <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-sm h-full flex flex-col">
                <div className="bg-gradient-to-r from-gray-800 to-gray-900 px-6 py-5 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300/70 text-sm mt-0.5">Northern California</p>
                  </div>
                </div>
                <div className="p-6 bg-white flex-1 flex flex-col">
                  <p className="text-gray-500 text-sm leading-relaxed mb-5">
      ...
      <section className="bg-white px-5 py-14 sm:px-8 sm:py-16 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <ScrollReveal direction="left">
              <h2 className="text-3xl font-black text-gray-800 sm:text-4xl">40+ Schools</h2>
      ...
      <section className="overflow-hidden bg-gray-50 py-14">
        <div className="mx-auto mb-8 max-w-6xl px-5 sm:px-8 lg:px-16">
          <div className="flex items-end justify-between gap-4">
            <ScrollReveal direction="left">
              <h2 className="text-3xl sm:text-4xl font-black text-gray-800">Our Sponsors</h2>
      ...
      <section className="bg-brand-950">
        <div className="mx-auto grid max-w-6xl gap-0 divide-y divide-white/10 px-5 py-12 sm:px-8 sm:py-16 md:grid-cols-2 md:divide-x md:divide-y-0 lg:px-16">
          <ScrollReveal direction="left">
            <div className="pb-12 md:pr-16 md:pb-0">
              <h2 className="mb-3 text-4xl font-black leading-none text-white sm:text-5xl">
                Team<br />Portal
              </h2>
              <p className="mb-7 max-w-md leading-7 text-white/70">
                Schedules, RSVPs, announcements, roster, chat — everything in one place.
              </p>
              <Link
                href="/sign-in"
                className="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-brand-950 bg-white rounded-xl hover:bg-brand-50 transition-colors"
              >
          ...
          <ScrollReveal direction="right" delay={80}>
            <div className="pt-12 md:pl-16 md:pt-0">
              <h2 className="mb-3 text-4xl font-black leading-none text-white sm:text-5xl">
                Support<br />the Team
              </h2>
              <p className="mb-7 max-w-md leading-7 text-white/70">
              ...
              <Link
                href="/donate"
                className="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-brand-600 rounded-xl hover:bg-brand-500 transition-colors"
              >
